...
// Since the useEffect is excuting before the auth start to work we have to call it as a fucntion and put that that ain the conditionsl 
useEffect(() => {
    const uid = () => auth.current.uid
    if(listing && listing.userRef !== uid){
...
////////////////////////////////////////////////////////////////////////
////////////  For Adding the userRef to form data object   /////////////
///////////////////////////////////////////////////////////////////////
useEffect(() => {
